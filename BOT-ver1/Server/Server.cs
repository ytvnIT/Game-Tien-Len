        ...
        {         
            ...
            while (true)
            {
                ...
                if(str.Contains("win"))
                {
                    ...
                    for (int i = 0; i < danhSachPhong[sophong].AI.Count; i++)
                        danhSachPhong[sophong].AI[i].ResetBot();
            ...
            else
            {
                ...
                if (temp.Contains("win"))
                {
                    if (turn < danhSachPhong[sophong].players.Count)
                        socketList2[danhSachPhong[sophong].players[turn].pos].SendData(temp);
                }
                else
                    if (turn < danhSachPhong[sophong].players.Count)
                ...
                for (int i=0;i<danhSachPhong[sophong].AI.Count;i++)                  
                {
                    if (turn == i + danhSachPhong[sophong].soNguoiChoiTaiLucChiaBai)
                    {
                        ...
                        if (temp.Contains("win"))
                        {
                            //danhSachPhong[sophong].AI[id].sBaiCuaDoiThu = temp;
                            //danhSachPhong[sophong].AI[id].Danh();
                            for (int y = 0; y < danhSachPhong[sophong].AI.Count; y++)
                                danhSachPhong[sophong].AI[y].ResetBot();
                        }
                        else
